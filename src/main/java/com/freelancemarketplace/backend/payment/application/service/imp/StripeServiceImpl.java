package com.freelancemarketplace.backend.payment.application.service.imp;
...
public class StripeServiceImpl implements StripeService {
    ...
    public StripeServiceImpl(@Value("${STRIPE_SECRET_KEY}") String stripeApiKey) {
    }
    ...
    public String createTestClientCustomer(String email, String name) throws StripeException {
        ...
        if (email == null || email.trim().isEmpty()) {
            throw new ApiException(HttpStatus.BAD_REQUEST, ErrorCode.INVALID_REQUEST, "Email cannot be null or empty");
        }
        if (name == null || name.trim().isEmpty()) {
            throw new ApiException(HttpStatus.BAD_REQUEST, ErrorCode.INVALID_REQUEST, "Name cannot be null or empty");
        }
