package com.freelancemarketplace.backend.email.application.service.imp;
...
public class EmailServiceImp implements EmailService {
    ...
    public void sendSimpleEmail(Long clientId, Long freelancerId, Long projectId, String to, String projectTitle, String text) {
        ...
        if (!isValidEmail(to)) {
            ...
            throw new ApiException(HttpStatus.BAD_REQUEST, ErrorCode.INVALID_REQUEST, "Invalid email address: " + to);
        }
